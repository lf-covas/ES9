# Tutorial: Criação e Execução do Backstage com Docker e SQLite
...
![alt text](ponderada/img/image.png)
...
## 5. Construindo uma imagem Docker
...
![alt text](ponderada/img/image-2.png)
...
![alt text](ponderada/img/image-4.png)